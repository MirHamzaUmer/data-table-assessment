...
from app.schemas import Paginated, UserResponse


router = APIRouter()


SORTABLE_COLUMNS = {"name", "email", "role", "created_at"}
...
async def list_users(
    ...
    cache_key = await make_cache_key("users:list", cache_params)
    ...
    base = select(User.id, User.name, User.email, User.role, User.created_at)
